...
class Booth implements Function {
    /**
  * Perform mainPackage.Booth's function. Domain is [-10, 10] Minimum is 0 at x = 1 & y = 3.
  */
    public double count(double... x) {
...
class Ackley implements Function {
    /**
     * Perform mainPackage.Ackley's function. Domain is [-5, 5] Minimum is 0 at x = 0 & y = 0.
     */
    public double count(double... x) {
